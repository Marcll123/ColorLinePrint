                            ...
                            <div class="row">
                                <div class="tab-content col-12" id="nav-tabContent">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <input type="text" id="firmante" class="form-control"
                                                    placeholder="Firmante">
                                                <label for="cargo"> Cargo:</label>
                                                <input type="text" id="cargo2" class="form-control" placeholder="Cargo">
                                        ...
                                        <div class="col-12">   
                                            <div class="row">
                                                <div class="col-4">
                                                    ...
                                                    <input type="text" id="nombreEmpresa" class="form-control" placeholder="N°">
                                                </div>
                                                <div class="col-4">                                                  
                                                    <p>Tipo de Contribuyente:</p>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="checkbox" id="inlineCheckbox1" value="option1">
                                                        <label class="form-check-label" for="inlineCheckbox1">Pequeño</label>
                                                    </div>                 
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="checkbox" id="inlineCheckbox1" value="option1">
                                                        <label class="form-check-label" for="inlineCheckbox1">Mediano</label>
                                                    </div>   
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="checkbox" id="inlineCheckbox1" value="option1">
                                                        <label class="form-check-label" for="inlineCheckbox1">Grande</label>
                                                    </div>                                                                                
                                                </div>
                                                <div class="col-4">
                                                    <label for="seriedocto"> Lineas por documento</label>
                                                    <input type="text" id="seriedocto" class="form-control"
                                                        placeholder="Cred. Fiscal">
                                                    <input type="text" id="nombreEmpresa" class="form-control" placeholder="Nota Credito">
                                                </div>
                                            </div> 
                                            <div class="row">
                                                <div class="col-6">
                                                    <label for="tipoC"> Cuentas para el IVA Credito Fiscal (Compras locales):</label>
                                                ...
                                                <div class="col-6">
                                                    <label for="formaP"> Cuentas para el IVA Credito Fiscal (Importaciones):</label>
                                                    <select id="tipoC" class="form-control form-control-sm">
                                                ...
                                                <div class="col-6">
                                                    <label for="tipoC"> Cuentas para el IVA Credito Fiscal (Contribuyentes):</label>
                                                    <select id="tipoC" class="form-control form-control-sm">
                                                        <option>Gravada</option>
                                                        <option>Exentas</option>
                                                    </select>
                                                ...
                                                <div class="col-6">
                                                    <label for="formaP"> Cuentas para el IVA Credito Fiscal (Consumidor Final):</label>
                                                    <select id="tipoC" class="form-control form-control-sm">
                                                        <option>Contado</option>
                                                        <option>Creditos</option>
                                                    </select>
                                    ...
                                    <div class="tab-pane fade" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab">
                                        <div class="col-12">
                                                    <form action="">
                                                        <label for="exampleFormControlTextarea1">Descripcion de la emprensa</label>
